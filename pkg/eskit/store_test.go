...
func (f *fakeClient) SubscribeWorkers(ctx context.Context, storeID uuid.UUID, handler func(*client.WorkerInventory), opts ...client.SubscribeWorkersOption) (api.Subscription, error) {
	return nil, nil
}
